...
type options struct {
	...
	Interpolator func(string, []driver.NamedValue) (string, []driver.NamedValue)
}
...
func WithInterpolator(interpolator func(string, []driver.NamedValue) (string, []driver.NamedValue)) func(*options) {
	return func(o *options) {
